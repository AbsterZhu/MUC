...
from common.pose_nets.module import PositionNet, HandRotationNet, FaceRegressor, BoxNet, HandRoI, BodyRotationNet
...
class Model(nn.Module):
    ...
    def forward(self, inputs, targets, meta_info, mode):
        ...
        # hand regressor
        hand_joint_hm, hand_joint_img = self.hand_position_net(hand_feat)  # (2N, J_P, 3)
        ...
        if mode == 'test' and 'smplx_pose' in targets and False:
        ...
        if mode == 'train':
            ...
            out['body_pose_token'] = body_pose_token
            out['cam_token'] = cam_token
            out['body_joint_img'] = body_joint_img
            out['img_feat'] = img_feat
            out['task_tokens'] = task_tokens
            out['hand_feat'] = hand_feat
            out['hand_pose_token'] = hand_token
            out['jaw_pose_token'] = jaw_pose_token
            out['expr_token'] = expr_token
            out['shape_token'] = shape_token
